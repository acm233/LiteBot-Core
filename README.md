...
[2022-04-02T23:00:01.330] [INFO] [WebSocket] - 服务器 “生存1服” 连接成功
[2022-04-02T23:00:01.330] [INFO] [WebSocket] - 服务器 “生存3服” 连接成功
[2022-04-02T23:00:01.331] [INFO] [WebSocket] - 服务器 “生存2服” 连接成功
...
"^(查服)$"|runcmd|"/list"|向BDS执行一条预定的控制台指令"/list"
"^(/cmd )(.+$)"|runcmd_raw|无|向BDS执行一条自定义的控制台指令
"^(绑定 )([A-Za-z0-9 ]{4,20})$"|allowlist_bind|无|自助绑定白名单
"^(申请白名单)$"|allowlist_add_self|无|自助添加白名单
"^(解绑)$"|allowlist_unbind|无|自助解绑白名单
"^(我的信息)$"|bind_check_self|无|查询本人的白名单绑定状态
"^(加白名单)(.+$)"|allowlist_add|无|为目标玩家添加白名单
"^(解绑 )(.+$)"|allowlist_del|无|删除目标玩家的白名单
"^(查绑定 )(.+$)"|bind_check|无|查询目标玩家的白名单绑定状态
